...
def generate_launch_description():
    ...
    config_path = os.path.join(this_directory, "config", "skidpad.yaml")
    ...
    start_skidpad_detect_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory("skidpad_detect"), "launch", "skidpad_detect.launch.py")
        ),
    )

    start_planning_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory("path_generator"), "launch", "skidpad.launch.py")
        ),
    )

    start_control_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory("fsd_control"), "launch", "skidpad.launch.py")
        ),
    )
    ...
    ld.add_action(start_skidpad_detect_cmd)
